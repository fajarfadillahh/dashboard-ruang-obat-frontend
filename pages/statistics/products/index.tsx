...
export default function ProductsStatisticsPage() {
  ...
  return (
    <Layout title="Produk - Ruang Obat" className="scrollbar-hide">
      <Container className="gap-8">
        <TitleText
          title="Produk - Ruang Obat 📝"
          text="Produk yang tersedia pada Ruang Obat"
        />
            ...
            {products.map((product) => {
              ...
              return (
                <div
                  ...
                  onClick={() =>
                    router.push(`/statistics/products/${product.code}`)
                  }
                >
                  <div
