...
export default function ApotekerClassAccessesPage({
  token,
  ...
  >({
    url: getUrl("/accesses/apotekerclass", {
      q: searchValue,
      filter,
      sort,
      page,
        ...
        return (
          <div className="inline-flex items-center gap-2">
            <Button
              ...
              onClick={() =>
                router.push(
                  `/apotekerclass/accesses/${access.access_id}/detail`,
                )
              }
            >
            ...
            {["active", "scheduled"].includes(access.status) ? (
              <>
                <Button
                  ...
                  onClick={() =>
                    router.push(
                      `/apotekerclass/accesses/${access.access_id}/change-plan`,
                    )
                  }
                >
                ...
                <Button
                  ...
                  onClick={() =>
                    router.push(
                      `/apotekerclass/accesses/${access.access_id}/universities`,
                    )
                  }
                >
                  <CustomTooltip content="Ubah Akses Universitas Pengguna">
                    <GraduationCap weight="duotone" size={18} />
                  </CustomTooltip>
                </Button>
  ...
  if (error) {
    return (
      <Layout title="Access List Kelas Masuk Apoteker">
        <Container>
          <ErrorPage
            {...{
        ...
        <div className="grid">
          <div className="sticky left-0 top-0 z-50 flex justify-end gap-4 bg-white pb-4">
            ...
            <Button
              ...
              onClick={() => router.push("/apotekerclass/accesses/create")}
