...
export default function SubscriptionsPage({
            ...
            <ModalConfirm
              trigger={
                <Button isIconOnly variant="light" color="danger" size="sm">
                  <CustomTooltip content="Hapus Langganan">
  ...
  return (
    <Layout title="Langganan" className="scrollbar-hide">
      <Container className="gap-8">
        <TitleText
          title="Daftar Langganan 📚"
          text="Langganan yang tersedia pada kelas masuk apoteker."
        />
          ...
          <div className="overflow-x-scroll scrollbar-hide">
            ...
            >
              ...
              <TableBody
                ...
                emptyContent={<EmptyData text="Langganan tidak ditemukan!" />}
              >
                {(packageSubscription: PackageSubscription) => (
