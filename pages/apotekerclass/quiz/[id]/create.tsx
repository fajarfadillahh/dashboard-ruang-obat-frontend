...
export default function CreateQuizPage({
  ...
  async function handleSaveQuiz() {
    ...
    try {
      ...
      localStorage.removeItem("input_quiz_apotekerclass");
      localStorage.removeItem("questions_quiz_apotekerclass");
    } catch (error: any) {
      console.error(error);
  ...
  useEffect(() => {
    const storedInput = localStorage.getItem("input_quiz_apotekerclass");
